...
for i in range(1):
    #exp_id = f'5dm_3mA_news_nzg_prd_dr0_mp5_3.5kit_r{i+1}'#f'5dm_3mS_news_zg_curb_2co_dr0.1_ad05m09m2_r{i+1}'
    ...
    data_list_f = open('/home/ubuntu/code/angle_rl/invest/data/prod/data_list_tr360d_bs25d_prod.txt', 'r')
