"""
LSTM Sequential Model - 750 iterations for 2023, 2024, 2025
Matching Sequential Supervised configuration for fair comparison
"""
...
# Parameters - 750 iterations to match Sequential Supervised
GAMMA = 0.3
LEARNING_RATE = 0.001
...
output_dir = f'{data_dir}lstm_750iter_2023_2025_{datetime.now().strftime("%Y%m%d_%H%M%S")}/'
...
print("\n" + "="*80)
print("TESTING 750 ITERATIONS ON 2023-2025")
...
# Save results
results_file = f'{output_dir}lstm_750iter_2023_2025_results.json'
...
# Create report
report_file = f'{output_dir}lstm_750iter_2023_2025_report.md'
with open(report_file, 'w') as f:
    f.write("# LSTM Results - 750 Iterations for 2023-2025\n\n")
