...
if __name__=="__main__":
    dl = '/home/ubuntu/code/angle_rl/invest/data/data_list_2023-04-05_2025-04-04_tr360d_bs25d_32dinterval_newsFeatureFalse_testmodeFalse.txt'
    d = {f"jun24_25d_L2C_run{i}":dl for i in range(8)}
    model_type = 'iimodel'
    for k, v in d.items(): 
