...
fiveyrs_start_date_time = '2024-05-17'
fiveyrs_end_date_time = '2025-05-16' ## requesting one full year data for now 

##### request all price data in the past 5 years 

#### request all price data for daily chart in the past 5 years 

#print('Requesting all price data for daily chart in the past 1 year for NYSE...')
#url_str = 'historical-chart/15min'
#pickle.dump(build_price_volume_chart_data(nyse_list, fiveyrs_start_date_time, fiveyrs_end_date_time, url_str), open('data/nyse_daily_price_volume_data_15min.pkl', 'wb'))

print('Requesting all price data for daily chart in the past 1 year for NASDAQ...')
#url_str = 'historical-chart/15min'
url_str = 'historical-chart/15min'
pickle.dump(build_price_volume_chart_data(nasdaq_list, fiveyrs_start_date_time, fiveyrs_end_date_time, url_str), open('data/nasdaq_daily_price_volume_data_15min.pkl', 'wb'))
