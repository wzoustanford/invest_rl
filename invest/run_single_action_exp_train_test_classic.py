...
def run_single_action_exp_train_test(exp_id, data_list_filename, model_type='iimodel'):
    ...
    #data_list_f = open('/home/ubuntu/code/angle_rl/invest/data/data_list_2023-04-05_2025-04-04_tr360d_bs25d_32dinterval_newsFeatureFalse_testmodeFalse.txt', 'r')
    #/home/ubuntu/code/angle_rl/invest/data/data_list_2023-12-04_2025-04-04_tr360d_bs5d_8dinterval_newsFeatureTrue_testmodeFalse.txt', 'r')
    ...
    while l:
        ...
        train_single_step_model(
            ...
            steps = 750, # tested 500 could be slightly better 
            lr = 0.001,
...
if __name__=="__main__":
    ...
    d = {
        ...
        'jun24_25d_plain':'/home/ubuntu/code/angle_rl/invest/data/data_list_2023-04-05_2025-04-04_tr360d_bs25d_32dinterval_newsFeatureFalse_testmodeFalse.txt',
    }
    model_type = 'iimodel'
    ## v2 model: 
    for k, v in d.items(): 
